-- Fixed admin_update_sensei_level function with explicit casting for JSON-safe types
...
BEGIN
  ...
  -- Insert level history with explicit casting for JSON-safe types
  INSERT INTO sensei_level_history (
    ...
    jsonb_build_object(
      ...
      'trips_led', COALESCE(sensei_record.trips_led, 0)::int,
      'rating', COALESCE(sensei_record.rating, 0.0)::float,
