-- Enhanced Admin Trip Builder Schema Updates (Final Version)
...
-- Populate activity library with sample data
...
('Cultural Walking Tour', 'cultural', ARRAY['city', 'historic'], ARRAY['cultural', 'education'], 'easy', 3, 'Explore historical sites and local culture', ARRAY[], ARRAY['year-round'], ARRAY[]),
...
('Photography Workshop', 'creative', ARRAY['any'], ARRAY['photography', 'nature'], 'easy', 4, 'Learn photography techniques in beautiful locations', ARRAY[], ARRAY['year-round'], ARRAY['camera']),
('Wildlife Safari', 'nature', ARRAY['savanna', 'forest'], ARRAY['nature', 'wildlife'], 'moderate', 8, 'Observe and photograph wildlife in natural habitat', ARRAY[], ARRAY['summer', 'autumn'], ARRAY['binoculars', 'camera']);
